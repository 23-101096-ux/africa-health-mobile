...
const RegisterPage = ({ onGoToLogin, onRegisterSuccess }) => {
  return (
    <div className="auth-mobile-container">
      <div className="auth-content">
        ...
        <div className="auth-toggle-box">
          <button className="toggle-btn" onClick={onGoToLogin}>Sign In</button>
          <button className="toggle-btn active">Register</button>
        </div>

        <div className="auth-form">
          <input type="text" placeholder="Full Name" className="auth-input-field" />
          ...
          <Button label="Create Account →" onClick={onRegisterSuccess} variant="primary" />
        </div>
