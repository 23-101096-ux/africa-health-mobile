  ...
  return (
    <div className="onboarding-container">
        ...
        {current === 0 && (
          <div className="content show">
            ...
            <div className="text-area">
              ...
              <p className="body">Browse sessions, speakers, and
                                  exhibitions shaping the future of
                                  African healthcare..</p>
            </div>
          </div>
        )}
        ...
        {current === 1 && (
          <div className="content show">
            ...
            <div className="text-area">
              ...
              <p className="body">Navigate the venue with ease. Find
                                  booths, halls, and premium exhibitors
                                  instantly.</p>
            </div>
          </div>
        )}
        ...
        {current === 2 && (
          <div className="content show">
            ...
            <div className="text-area">
              ...
              <p className="body">Your pass, always in your pocket.
                                  Quick access to all your registered
                                  events.</p>
            </div>
          </div>
        )}
      ...
      <div className="bottom-area">
        <div className="dots">
          <button onClick={() => setCurrent(0)} className={`dot ${current === 0 ? "active" : ""}`} />
          <button onClick={() => setCurrent(1)} className={`dot ${current === 1 ? "active" : ""}`} />
          <button onClick={() => setCurrent(2)} className={`dot ${current === 2 ? "active" : ""}`} />
        </div>
